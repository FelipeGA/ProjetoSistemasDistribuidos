...
while True:
    ...
    print(
        " 1 - Data e Hora\n 2 - Previsão do tempo\n 3 - Placar do campeonato brasileiro\n 4 - Lembrete\n 5 - Notícias\n 6 - Conte uma piada\n 7 - Contatos\n 8 - Calculadora\n\n")
    ...
    if option == 1:
        ...
        uri = nameserver.lookup("example.placar")
        print(Pyro4.Proxy(uri).get_placar())
        ...
        uri = nameserver.lookup("example.piadas")
        print(Pyro4.Proxy(uri).get_piada())
